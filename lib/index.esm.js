...
__vue_render__$3._withStripped = true;
  ...
  const __vue_inject_styles__$3 = function (inject) {
    if (!inject) return
    inject("data-v-3bb7d334_0", { source: "\ntr[data-v-3bb7d334] {\n  background-color: white;\n  border-radius: 4px;\n  box-shadow: 0 2px 6px 0 rgba(0, 0, 0, 0.08);\n}\ntd[data-v-3bb7d334] {\n  padding: 8px;\n}\n", map: {"version":3,"sources":["/Users/juuyoung/Documents/github/components/src/KTableRow/KtableRow.vue"],"names":[],"mappings":";AAqBA;EACA,uBAAA;EACA,kBAAA;EACA,2CAAA;AACA;AACA;EACA,YAAA;AACA","file":"KtableRow.vue","sourcesContent":["<template>\n  <tr>\n    <td v-for=\"(value, index) in values\" :key=\"index\">\n      {{ value }}\n    </td>\n  </tr>\n</template>\n\n<script>\nexport default {\n  name: 'KTableRow',\n  props: {\n    values: {\n      type: Array,\n      // required: true\n    }\n  }\n}\n</script>\n\n<style scoped>\ntr {\n  background-color: white;\n  border-radius: 4px;\n  box-shadow: 0 2px 6px 0 rgba(0, 0, 0, 0.08);\n}\ntd {\n  padding: 8px;\n}\n</style>"]}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$3 = "data-v-3bb7d334";
  /* module identifier */
...
__vue_render__$1._withStripped = true;
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-44236314_0", { source: "\ntr[data-v-44236314] {\n  background-color: white;\n  border-radius: 4px;\n  box-shadow: 0 2px 6px 0 rgba(0, 0, 0, 0.08);\n}\ntd[data-v-44236314] {\n  padding: 8px;\n}\n", map: {"version":3,"sources":["/Users/juuyoung/Documents/github/components/src/KTableRow/KTableRow.vue"],"names":[],"mappings":";AAqBA;EACA,uBAAA;EACA,kBAAA;EACA,2CAAA;AACA;AACA;EACA,YAAA;AACA","file":"KTableRow.vue","sourcesContent":["<template>\n  <tr>\n    <td v-for=\"(value, index) in values\" :key=\"index\">\n      {{ value }}\n    </td>\n  </tr>\n</template>\n\n<script>\nexport default {\n  name: 'KTableRow',\n  props: {\n    values: {\n      type: Array,\n      // required: true\n    }\n  }\n}\n</script>\n\n<style scoped>\ntr {\n  background-color: white;\n  border-radius: 4px;\n  box-shadow: 0 2px 6px 0 rgba(0, 0, 0, 0.08);\n}\ntd {\n  padding: 8px;\n}\n</style>"]}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$1 = "data-v-44236314";
  /* module identifier */
...
export { __vue_component__$2 as KTable, __vue_component__$1 as KTableRow, __vue_component__ as Task };
